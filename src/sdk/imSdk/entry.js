...
const sdkConfig = {
  ...
  // baseURL: startalkNav.baseaddess && startalkNav.baseaddess.IMBaseURL,
  baseURL: ''
}
...
class QtalkSDK extends EventEmitter {
  ...
  constructor(options) {
    ...
    this.connection
      .on('connect:success', (stropheConnection) => {
        console.log('im_connect:success===============')
      ...
      .on('connect:disconnected', () => {
        console.log('im_connect:disconnected================')
   ...
   * @param  {[type]} backupinfo [description]
   * @return {[type]}            [description]
   */
  async sendMessageTo(msg, msgType = '5', toUser, backupinfo) {
    const { bareJid, message, options } = this;
    const uuid = createUUID();
    const isGroup = message.currentSessionType === 'groupchat';
    const to = toUser;
  ...
  async getUserCard(arr) {
    ...
    const req = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/newapi/domain/get_vcard_info.qunar',
  ...
  async setUserProfile(desc) {
    ...
    const req = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/newapi/profile/set_profile.qunar',
      headers: { 'Content-Type': 'application/json' },
      params: {
        u: myId,
        k: key
  ...
  async getGroupCard(arr) {
    ...
    const req = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/newapi/muc/get_muc_vcard.qunar',
      headers: { 'Content-Type': 'application/json' },
      params: {
        u: this.myId,
        k: this.key
  ...
  async getSessionList() {
    ...
    const ret = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/package/qtapi/getrbl.qunar', //.darlyn
      headers: { 'Content-Type': 'application/json' },
      data: JSON.stringify(data)
    });
  ...
  async getHistoryMsg(to, pageSize = 20, isFirst) {
    ...
    const ret = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/package/qtapi/getmsgs.qunar',//.darlyn
      headers: { 'Content-Type': 'application/json' },
      data: JSON.stringify({
        from: myId,
  ...
  async getGroupHistoryMsg(muc, pageSize = 20, isFirst) {
    ...
    const ret = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/package/qtapi/getmucmsgs.qunar',//.darlyn
      headers: { 'Content-Type': 'application/json' },
      data: JSON.stringify({
  ...
  async getCompanyStruct() {
    ...
    //   }
    // });
    const req = await axios.post( sdkConfig.baseURL + '/newapi/update/getUpdateUsers.qunar', {
      version: 0 // 全量
    });
    return {
      ret: true,
  ...
  async updateMucCard(data) {
    ...
    const ret = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/newapi/muc/set_muc_vcard.qunar',
      headers: { 'Content-Type': 'application/json' },
      params: {
        u: myId,
        k: key
  ...
  async searchUser(val) {
    ...
    const ret = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/py/search',
      headers: { 'Content-Type': 'application/json' },
      data: JSON.stringify(data)
    });
    const res = ret.data;
  ...
  async getTopInfo() {
    ...
    const req = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/newapi/configuration/getincreclientconfig.qunar',
      headers: {
  ...
  async setTopInfo(ids) {
    ...
    const req = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/newapi/configuration/setclientconfig.qunar',
      headers: { 'Content-Type': 'application/json' },
      params: {
        u: myId,
        k: key,
  ...
  async getIncrementMucs() {
    ...
    const req = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/newapi/muc/get_increment_mucs.qunar',
      headers: { 'Content-Type': 'application/json' },
  ...
  async getDomainList() {
    const ret = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/newapi/domain/get_domain_list.qunar?t=qtalk',
      headers: { 'Content-Type': 'application/json' },
      data: JSON.stringify({
        version: 0
      })
  ...
  async searchSbuddy(data) {
    const ret = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/package/s/qtalk/sbuddy.php',
      headers: { 'Content-Type': 'application/json' },
      data: JSON.stringify(data)
    });
    const res = ret.data;
  ...
  async onLineStatus(data) {
    ...
    const ret = await axios({
      method: 'post',
      url: sdkConfig.baseURL + '/newapi/domain/get_user_status.qunar?v=10121100',
      headers: { 'Content-Type': 'application/json' },
      // params: {
      //   u: myId,
      //   k: key,
