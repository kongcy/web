<template>
  <div class="holder">
    <!-- <el-dialog :visible.sync="isVisible" title="云台控制" width="780px" -->
    <el-dialog :visible.sync="isVisible" :title="ytTitle" width="400px" v-dialogDrag 
      class="custom-dialog" :class="isNVRChannel?'dialogNVR':''" :append-to-body="true" @closed="closedDialog"
