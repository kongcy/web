<template>
<div>
    <el-dialog :visible.sync="visible"  title="开启会议" width="600px" center class="custom-dialog">
        <el-form :model="form" :rules="rules" ref="form" label-width="85px" @keyup.enter.native="start">
            <el-row :gutter="20">
                <el-col :span=" this.apiSDK.config.version === this.apiSDK.enumSDKVersion.SDKVersion6 ? 14 : 24 ">
                    <el-form-item label="会议名称" prop="name">
                        <el-input  v-model="form.name"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span=" this.apiSDK.config.version === this.apiSDK.enumSDKVersion.SDKVersion6 ? 10 : 0 " class="newCol">
                    <!-- <el-switch v-model="form.media" :active-value="true" :inactive-value="false"></el-switch> -->
                    <!-- <span>启用媒体设备</span> -->
                    会议模式： <el-radio v-model="form.modeRadio" label="1">常规</el-radio>
...
export default {
    ...
    methods: {
        ...
        showDialog (data, type, mediaType) {
            this.personData = []
            this.deviceData = []
            if (type === 'temp') {
