<template>
  <div id="divResourceArea" width="300px">
    ...
    <div id="divResourceOperate">
      <input type="button" id="btnRecord" title="批量点播" @click="startPlays"  v-if="activetabName=='Monitor'">
    ...
    <!-- 资源显示区域 -->
    <div class="tabWrap" :style="{height:activetabName!='Monitor'?'calc(100% - 40px)':'calc(100% - 80px)'}">
