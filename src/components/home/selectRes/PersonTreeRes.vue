    ...
    <div class="treeBox" style="text-align:center">
        <div class="serachWrap">
            <el-row :gutter="5" style="margin:0px">
                ...
                <el-col :span="apiSDK.config.version === apiSDK.enumSDKVersion.SDKVersion6?24:20" v-if="apiSDK.config.version === apiSDK.enumSDKVersion.SDKVersion6 || (apiSDK.config.version === apiSDK.enumSDKVersion.SDKVersion5 && searchChange)" style="margin-bottom:10px;">
                    <div class="search" >
                ...
                <el-col :span="12" v-if="apiSDK.config.version === apiSDK.enumSDKVersion.SDKVersion6 || (apiSDK.config.version === apiSDK.enumSDKVersion.SDKVersion5 && !searchChange)">
                ...
                <el-col :span="1" style="height: 50px;"></el-col>
                <el-col :span="11" v-if="apiSDK.config.version === apiSDK.enumSDKVersion.SDKVersion6 || (apiSDK.config.version === apiSDK.enumSDKVersion.SDKVersion5 && !searchChange)">
                    <el-dropdown placement="bottom" @command="handleCommandChange">
                        <span class="el-dropdown-link">
                            {{levelValue | filterLevel}}
                            <i class="el-icon-arrow-down el-icon--right icon-Command"></i>
                        </span>
                        <el-dropdown-menu slot="dropdown">
...
.serachWrap .el-dropdown /deep/ .el-icon--right{
    margin-left: 112px;
}
.serachWrap .el-dropdown .icon-Command{
    margin-left: 67px;
}
</style>
