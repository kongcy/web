<template>
    ...
    <div style="padding: 10px">
      ...
      <button @click="testVideo">测试hls视频显示</button>
    </div>
  ...
  methods: {
    ...
    testVideo(){
        ...
        this.$nextTick(() => {
            let pos = 0;
            let resourceType = 0;
            let rtmpURL = 'http://172.16.2.203:9000/playlist.m3u8?start=1595585010&end=1595585610&stream=41000000020000000002&baseurl=http://172.16.2.203:9000/live';
            let type = 'hls';
            playerSDKNew.startPlayByRTMP(pos, resourceType, rtmpURL, type);
        })
    },
